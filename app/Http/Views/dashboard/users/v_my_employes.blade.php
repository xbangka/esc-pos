            ...
            <div class="page-title-heading">
                ...
                <div>Pengguna
                    <div class="page-title-subheading">
                        Karyawan / Pegawai Toko / Pengguna
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row {{$app}}">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Pengguna : {{$data->store_name . ' / ' .$data->store_code}}
                ...
                <div :style="(showform) ? '':'display:none'">
                    <div class="offset-md-3 col-md-6 col-xs-12">
                        ...
                        <div class="position-relative row form-group">
                            <label for="a8" class="col-sm-4 col-form-label text-right">Pin</label>
                            <div class="col-sm-8">
                                <input id="a8" type="text" class="form-control" v-model="pin">
                            </div>
                        </div>

                        <div class="offset-sm-4 col-sm-8 pt-2">
                            <div class="mb-5 progress" :style="(loading)?'min-width: 100% !important':'display: none'">
