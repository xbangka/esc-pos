	...
	methods:
	{
		...
		save: function (){
			if( this.code.length==0 ){
				...
				Swal.fire({
					html: _iconsvgwarning+'<h4 class="mt-4">Kode</h4><span class="mt-5">Kode yang di ketik salah,<br/>req: 3 char</span>'
				});
				return false;
			}
			if( this.name.length==0 ){
				...
				Swal.fire({
					html: _iconsvgwarning+'<h4 class="mt-4">Nama Satuan</h4><span class="mt-5">Nama yang di ketik terlalu pendek,<br/>min:4, max:30</span>'
				});
				return false;
			}
			this.loading = true;
        ...
        senddata: function (){
			...
			var _q 	= {code:this.code,name:this.name,uuid:this.uuidedit};
