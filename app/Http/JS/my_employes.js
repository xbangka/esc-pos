...
$(document).ready(function() {
    ...
    dataTable = $('#dataTable').DataTable({
        ...
        columns: [
            ...
            {   data: 'mailx',      name: 'users.email'},
            {   data: 'telpx',      name: 'users.phone'},
            ...
            {   data: 'modify', name: 'users.updated_at'},
...
var app = new Vue({
	...
	methods:
	{
		...
		save: function (){
            ...
            if( this.pin!='' && (this.pin.length!=5 || isNaN(this.pin)) ){
				Swal.fire({
					html: _iconsvgwarning+'<h4 class="mt-4">Nomor Pin</h4><span class="mt-5">Nomor pin tidak benar max: 5 digit angka</span>'
				});
				return false;
            }
